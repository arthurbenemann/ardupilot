...
public abstract class MAVLinkClient{
	...
	public void init() {
		...
		startedInit = true;
		parent.getApplicationContext().bindService(new Intent(parent, MAVLinkService.class), mConnection, Context.BIND_AUTO_CREATE);
	...
	public boolean isConnected() {
		return true; 		// TODO Must be fixed, or the app can crash if we try to communicate without a connection
	}	
